function prepareData(filterParams){
    ...
    const payloads =
        ...
        //   payload.customers
        //     .map((customer) => customer.toLowerCase().trim())
        ...
        console.log(`Mission: ${mission.mission_name}, Launch Year Match: ${isLaunchYearMatch}, Customer Match: ${isCustomerMatch}`);
        ...
        const payloadsCountDiff = (b.rocket.second_stage.payloads.length || 0) - (a.rocket.second_stage.payloads.length || 0);
